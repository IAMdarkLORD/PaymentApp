...
////        ANURAG SANJAY BHALEKAR
////        kpersonalacc4@okicici
////        anuragbhalekar17@okhdfcbank
////        KARAN SOMANATHAN NAIR
//    }

    void payUsingUpi(String amount, String note) {

        Uri uri = Uri.parse("upi://pay").buildUpon()
                .appendQueryParameter("pa", "kpersonalacc4@okicici")
                .appendQueryParameter("pn", "KARAN SOMANATHAN NAIR")
